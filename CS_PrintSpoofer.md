...
namespace PrintSpooferNet
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //at this point code will start pipe server, listen for incoming connections and impersonate them
            //following is only for understanding purposes and is not needed for an exploit
            ...
            //until here, code serves for learning purposes and is not needed for an exploit.
